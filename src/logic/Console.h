...
public:
    ...
    {
        SuggestionBase(const std::vector<std::string>& aliasList) : aliasList(aliasList),
                                                                    anyStartsWith(false)
        {
        }
    ...
    {
        NPCSuggestion(const std::vector<std::string>& aliasList, Handle::EntityHandle npcHandle) : SuggestionBase(aliasList),
                                                                                                   npcHandle(npcHandle)
        {
        }
